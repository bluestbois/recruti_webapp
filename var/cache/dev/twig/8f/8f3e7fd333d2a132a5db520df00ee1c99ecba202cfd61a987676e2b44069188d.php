...
class __TwigTemplate_b1d85560af952e3f1ce92af5f5f4db1e57bb9621ff5634d5fbb16fe8d542a9e3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form style=\"display: inline-block\" method=\"post\" action=\"{{ path('question_delete', {'id': question.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
...
", "question/_delete_form.html.twig", "F:\\recruti_webapp\\templates\\question\\_delete_form.html.twig");
    }
}
