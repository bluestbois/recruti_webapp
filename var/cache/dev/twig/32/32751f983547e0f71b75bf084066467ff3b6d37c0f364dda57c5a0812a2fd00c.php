...
";
    ...
    ";
        // line 19
        echo twig_include($this->env, $context, "post/_form.html.twig", ["button_label" => "Update", "icon" => "sync"]);
        echo "
...
";
    ...
    {
        return array (  145 => 19,  141 => 17,  131 => 16,  120 => 14,  110 => 13,  96 => 8,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% block gobackbtn %}
    ...
    <a href=\"{{ path(\"post_index\") }}\" class=\"d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm\">
        <i class=\"fas fa-arrow-left fa-sm text-white-50\"></i> Go back
    </a>
{% endblock %}
...
{% block main %}
    ...
    {{ include('post/_form.html.twig', {'button_label': 'Update' ,'icon': 'sync'}) }}


{% endblock %}
", "post/edit.html.twig", "F:\\recruti_webapp\\templates\\post\\edit.html.twig");
    }
}
