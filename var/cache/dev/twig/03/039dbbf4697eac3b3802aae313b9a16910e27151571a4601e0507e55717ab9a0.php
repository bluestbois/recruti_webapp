...
class __TwigTemplate_331e0f6047759337263d183faeeaf42c4096ce52528d127a3d4caa74c8b95f86 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 17
        echo twig_include($this->env, $context, "event/_form.html.twig", ["button_label" => "Update", "icon" => "sync"]);
        echo "
...
{% block main %}
    ...
    {{ include('event/_form.html.twig', {'button_label': 'Update', 'icon': 'sync'}) }}

{% endblock %}
", "event/edit.html.twig", "F:\\recruti_webapp\\templates\\event\\edit.html.twig");
    }
}
