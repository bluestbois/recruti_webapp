...
class __TwigTemplate_36dcdb6d8ed23048975d60272b8bb08142d9d815fc412fef9e8dd3965618a25b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <script>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["forums"]) || array_key_exists("forums", $context) ? $context["forums"] : (function () { throw new RuntimeError('Variable "forums" does not exist.', 19, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["forum"]) {
            // line 20
            echo "            {
                \"ID\" : \"";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forum"], "id", [], "any", false, false, false, 21), "html", null, true);
            echo "\",
                \"Title\" : \"";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forum"], "title", [], "any", false, false, false, 22), "html", null, true);
            echo "\",
                \"Description\" : \"";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["forum"], "description", [], "any", false, false, false, 23), "html", null, true);
            echo "\",
                \"Action\":   document.createElement(\"div\").innerHTML = `<div style=\"display: flex; justify-content: center\">
                                <a href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("forum_show", ["id" => twig_get_attribute($this->env, $this->source, $context["forum"], "id", [], "any", false, false, false, 25)]), "html", null, true);
            echo "\"><button type=\"button\" class=\"btn btn-sm shadow-sm btn-info mt-2 mb-2 ml-2\"><i class=\"fas fa-search\"></i></button></a>
                                <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("forum_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["forum"], "id", [], "any", false, false, false, 26)]), "html", null, true);
...
";
    ...
    {
        return array (  248 => 77,  222 => 53,  212 => 52,  182 => 30,  172 => 26,  168 => 25,  163 => 23,  159 => 22,  155 => 21,  152 => 20,  148 => 19,  142 => 16,  137 => 15,  127 => 14,  115 => 11,  112 => 10,  102 => 9,  91 => 6,  81 => 5,  62 => 3,  39 => 1,);
    }
    ...
    <script>
        let data = [
            {% for forum in forums %}
            {
                ...
                \"Action\":   document.createElement(\"div\").innerHTML = `<div style=\"display: flex; justify-content: center\">
                                <a href=\"{{ path('forum_show', {'id': forum.id}) }}\"><button type=\"button\" class=\"btn btn-sm shadow-sm btn-info mt-2 mb-2 ml-2\"><i class=\"fas fa-search\"></i></button></a>
                                <a href=\"{{ path('forum_edit', {'id': forum.id}) }}\"><button type=\"button\" class=\"btn btn-sm shadow-sm mt-2 mb-2 ml-2\"><i class=\"far fa-edit\"></i></button></a>
                            </div>`
            },
            {% endfor %}
        ]
...
{% block main%}
    ...
    <div style=\"width: 100%; display:flex; justify-content: flex-end\">
        <a href=\"{{ path('forum_new') }}\"><button type=\"button\" class=\"btn btn-primary btn-sm shadow-sm mt-2 mb-2\"><i class=\"far fa-plus-square\"></i> Create New</button></a>
    </div>

{% endblock %}
", "forum/index.html.twig", "F:\\recruti_webapp\\templates\\forum\\index.html.twig");
    }
}
