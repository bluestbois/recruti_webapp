    ...
    <script>
        let data = [
            {% for comment in comments %}
            {
                ...
                \"Likes\": \"{{ comment.likes }}\",
                \"Action\":   document.createElement(\"div\").innerHTML = `<div style=\"display: flex; justify-content: center\">
                                <a href=\"{{ path('comment_show', {'id': comment.id}) }}\"><button type=\"button\" class=\"btn btn-sm shadow-sm btn-info mt-2 mb-2 ml-2\"><i class=\"fas fa-search\"></i></button></a>
                                <a href=\"{{ path('comment_edit', {'id': comment.id}) }}\"><button type=\"button\" class=\"btn btn-sm shadow-sm mt-2 mb-2 ml-2\"><i class=\"far fa-edit\"></i></button></a>
                            </div>`
            },
            {% endfor %}
        ]
...
{% block main %}
    ...
    <div style=\"width: 100%; display:flex; justify-content: flex-end\">
        <a href=\"{{ path('comment_new') }}\"><button type=\"button\" class=\"btn btn-primary btn-sm shadow-sm mt-2 mb-2\"><i class=\"far fa-plus-square\"></i> Create New</button></a>
    </div>

{% endblock %}
", "comment/index.html.twig", "F:\\recruti_webapp\\templates\\comment\\index.html.twig");
    }
}
