...
/* event/new.html.twig */
class __TwigTemplate_2dac680de4d89be006c5e45b1e5c4f733b53c860fc081c71b4fdb62a720fb689 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  140 => 16,  136 => 14,  126 => 13,  111 => 9,  101 => 8,  90 => 5,  80 => 4,  61 => 3,  38 => 1,);
    }
...
{% block gobackbtn %}
    <a href=\"{{ path(\"event_index\") }}\" class=\"d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm\">
        <i class=\"fas fa-arrow-left fa-sm text-white-50\"></i> Go back
    </a>
{% endblock %}
{% block main %}
...
{% endblock %}
", "event/new.html.twig", "F:\\recruti_webapp\\templates\\event\\new.html.twig");
    }
}
