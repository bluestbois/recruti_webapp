...
/* tag/new.html.twig */
class __TwigTemplate_067e050554ef1f9a8f9bc1ef0f02ad5304177b8c26a9e205095e1d74472430f8 extends Template
{
    private $source;
    private $macros = [];
...
{% block gobackbtn %}
    <a href=\"{{ path(\"tag_index\") }}\" class=\"d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm\">
        <i class=\"fas fa-arrow-left fa-sm text-white-50\"></i> Go back
    </a>
{% endblock %}
{% block main %}
...
{% endblock %}
", "tag/new.html.twig", "F:\\recruti_webapp\\templates\\tag\\new.html.twig");
    }
}
